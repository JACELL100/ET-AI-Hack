    ...
    <div style={{ minHeight: "100vh", backgroundColor: "var(--bg-primary)", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ width: "100%", maxWidth: "420px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.875rem", color: "var(--text-secondary)" }}>Sign in to the RAKSHA portal</p>
        </div>
        ...
        <div style={{ background: "var(--bg-secondary)", border: "1px solid var(--bg-border)", borderRadius: "var(--radius-xl)", padding: "2rem" }}>
          ...
          <button 
            ...
            disabled={loading} 
            style={{ width: "100%", padding: "0.875rem", background: "white", color: "#111827", border: "1px solid #D1D5DB", borderRadius: "var(--radius-md)", fontSize: "0.9375rem", fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", transition: "all 200ms ease" }}
          >
            {loading ? (
